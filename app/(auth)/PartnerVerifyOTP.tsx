...
const PartnerVerifyOTP = () => {
  ...
  const { admin ,setToken,userId, baseURL ,isVerified ,setVerified} = useContext(AuthContext);
  ...
  const handleVerifyCode = async () => {
    ...
    try {
      ...
      let userID =admin.id;
        ...
        const response = await axios.post(`${baseURL}/api/partner/confirm/${userID}`, {
        ...
        if (response.status === 200) {
              ...
              router.push("/(auth)/PartnerPasswordResetScreen");
